...
3. Earlier, the Admins couldn’t push a file to multiple SD cards at the same time. Now, the Admins can use the scheme format (scheme: path) to accomplish this task. Please reach out to your sales contact to know more about this feature.  

4. A New Command Request— UPDATE_OEM_CONFIG is added to trigger/set values to the APIs exposed via OEM SDKs. Please reach out to your sales contact to learn more about this feature.  
