...
5. **Start Developing** 
     ...
     If you are using the Python SDK in Android Studio to call the Esper APIs using the Esper SDK, see [Esper SDK](./pythonsdk.md) Download the Command line tool, Esper CLI with full source code, to work the Esper APIs Download the Esper CLI [Esper CLI](./espercli.md)
